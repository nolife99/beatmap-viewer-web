...
import type DrawableSliderTick from '../../BeatmapSet/Beatmap/HitObjects/DrawableSliderTick.ts';
...
export const update = (drawable: DrawableSliderTick, time: number) => {
  ...
  const shouldHit = !drawable.evaluation ||
    ![
      HitResult.Miss,
  ...
  drawable.container.x = drawable.object.startX +
    drawable.object.stackedOffset.x;
  drawable.container.y = drawable.object.startY +
    drawable.object.stackedOffset.y;
