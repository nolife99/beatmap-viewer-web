import DrawableSliderBall from '../../BeatmapSet/Beatmap/HitObjects/DrawableSliderBall.ts';
...
export const update = (drawable: DrawableSliderBall, time: number) => {
	...
	drawable.container.x = drawable.object.startX + position.x +
		drawable.object.stackedOffset.x;
	drawable.container.y = drawable.object.startY + position.y +
